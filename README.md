...
![](https://github.com/kevinm126/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/kevinm126/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/kevinm126/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/kevinm126/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/kevinm126/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
|                        | elapsed time in mins (sequential) | elapsed time in mins (parallel) 
|
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | `7:47.21`                 | `0:15.15`                 | 
| `pg_normalized_batch`  | `1:23.69                  | `0:14.53`                 | 
| `pg_denormalized`      | `0:18.09`                 | `0:3.58`                  | 
